  ...
  const [userData, setUserData] = useState({ email: '', password: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!data.success) {          
            ...
            cookies.set('userToken', data.user.token, { domain: 'degree-calculator-api.vercel.app', expires: date30 });
            cookies.set('user', JSON.stringify(data.user), { domain: 'degree-calculator-api.vercel.app', expires: date30 });
