...
import {login, register, verify, getUser, updateUserInfo, updateUserPassword, resetPasswordEmail, resetPasswordToken, updateDegree, googleAuth, completeRegistration} from '../controllers/userController.js';
...
router.route('/complete-registration/:id').post(completeRegistration);
